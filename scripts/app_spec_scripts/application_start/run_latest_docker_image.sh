...
export image_id=sudo docker images -q $IMAGE_NAME
...
sudo docker run --detach --name personal-site --env "VIRTUAL_HOST=wilsonnie.ca" --env "VIRTUAL_PORT=80" --env "VIRTUAL_PORT=443" --env "LETSENCRYPT_HOST=wilsonnie.ca" 8bcc9df00fb4
