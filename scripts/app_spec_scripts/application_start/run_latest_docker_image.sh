...
sudo docker run --detach --name personal-site --env "VIRTUAL_HOST=wilsonnie.ca" --env "VIRTUAL_PORT=80" --env "VIRTUAL_PORT=443" --env "LETSENCRYPT_HOST=wilsonnie.ca" $image_id
